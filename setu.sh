...
LIMIT_HANDLER() {
    ...
    wget https://raw.githubusercontent.com/kayu55/angin/main/LimitHandler/install.sh && chmod +x install.sh && ./install.sh

    # Download file limit-ip ke /usr/bin/
    cd
    wget -q -O /usr/bin/limit-ip "${ARYAPRO}LimitHandler/limit-ip"
...
OPVPN_SETUP() {
    ...
    wget https://raw.githubusercontent.com/kayu55/angin/main/configure/openvpn
    chmod +x openvpn
    ./openvpn
